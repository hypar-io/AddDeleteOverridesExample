...
namespace AddDeleteOverridesTest
{
    public class Function
    {
        ...
        private IModelStore<AddDeleteOverridesTestInputs> store;

        public async Task<AddDeleteOverridesTestOutputs> Handler(AddDeleteOverridesTestInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<AddDeleteOverridesTestInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<AddDeleteOverridesTestInputs,AddDeleteOverridesTestOutputs>(store, AddDeleteOverridesTest.Execute);
